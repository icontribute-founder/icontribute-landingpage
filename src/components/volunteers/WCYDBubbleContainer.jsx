...
import WCYDBubble from "./WCYDBubble";
import "../../css/WYCDBubble.css";
import iPhone from "../../images/Group 3.png";
...
const WCYDBubbleContainer = (props) => {
  ...
  return (
    <div className="photoblock-container">
      <img className="WCYD-image" src={state.img}></img>
      <div>
